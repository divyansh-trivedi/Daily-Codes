<h2><a href="https://leetcode.com/problems/xor-after-range-multiplication-queries-ii/solutions/?envType=daily-question&envId=2026-04-09">3975. XOR After Range Multiplication Queries II</a></h2><h3>Hard</h3><hr><p>You are given an integer array <code>nums</code> of length <code>n</code> and a 2D integer array <code>queries</code> of size <code>q</code>, where <code>queries[i] = [l<sub>i</sub>, r<sub>i</sub>, k<sub>i</sub>, v<sub>i</sub>]</code>.</p>
